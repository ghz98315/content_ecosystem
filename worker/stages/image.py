...
def _build_grid_prompt(scenes: list[str], category: str = "health") -> str:
    ...
    }.get(category, "整体适合中老年观众和图书健康知识内容；避免泛黄、褪色、昏暗、破败、过度怀旧、沉重疾病感、卡通、动漫、儿童插画、3D医疗模型和夸张广告视觉。若场景涉及情绪危机或生命风险，只表现明亮安全的日常支持、家人陪伴、舒缓活动和规律生活；画面保持积极、平和、完整、无危险暗示，不呈现任何令人不安的细节、工具或姿态。")
    return (

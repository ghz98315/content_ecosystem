...
PROFILES: dict[str, ImageStyleProfile] = {
    "history_heroic": ImageStyleProfile(
        ...
        "正统帝王画卷·朝代考据风",
        "9:16竖版，中国传统工笔院体画，历代帝王图卷，熟宣泛黄绢本肌理，工笔铁线勾勒，多层轻透淡彩，低饱和文人矿物色，明朗通透全景平光；中轴对称或大殿三分构图，前景案几奏折，中景帝王与核心人物，后景朝堂大殿、山水屏风与百官群像；严格保持同一朝代的冠冕、袍服、官制和建筑考据。战争只用列阵、残垣、碎裂玉玺等象征表达，不出现血腥。",

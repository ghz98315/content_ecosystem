...
type VoiceProfile = { id: string; display_name: string; provider: "edge" | "cosyvoice2"; model?: string | null; voice_id: string; enabled: boolean; authorization_confirmed: boolean; sample_path?: string | null; updated_at?: string };
